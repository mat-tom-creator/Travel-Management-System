...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run(){
        try{
            String[] text = new String[] {"JW Marriot Hotel","Madarin Oriental Hotel","Four Seasons Hotel","Raddisson Blue Hotel","Classio Hotel","The Bay Club Hotel","Breeze Blow Hotel","The Taj Hotel","Prestige Hotel","River View Hotel"};
            for(int i = 0; i <= 9; i++){
